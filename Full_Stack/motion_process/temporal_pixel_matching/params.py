...
def left_cheek(frame, bbox, DELTA=DELTA, CHEEK_HPAD=CHEEK_HPAD, CHEEK_VPAD=CHEEK_VPAD, region = 'true'):

    if region.lower() == 'true':
        ...
        return [((bbox[1] + int(bbox[3] * CHEEK_VPAD) - DELTA),(bbox[1] + int(bbox[3] * CHEEK_VPAD) + DELTA)),
                ((bbox[0] + int(bbox[2] * CHEEK_HPAD) - DELTA),(bbox[0] + int(bbox[2] * CHEEK_HPAD) + DELTA))]


def right_cheek(frame, bbox, DELTA=DELTA, CHEEK_HPAD=CHEEK_HPAD, CHEEK_VPAD=CHEEK_VPAD, region = 'true'):
    if region.lower() == 'true':
        return frame[(bbox[1] + int(bbox[3] * CHEEK_VPAD) - DELTA):(bbox[1] + int(bbox[3] * CHEEK_VPAD) + DELTA),
...
def chin(frame, bbox, DELTA=DELTA, CHIN_HPAD=CHIN_HPAD, CHIN_VPAD=CHIN_VPAD, region = 'true'):
    ...
    if region.lower() == 'true':
        ...
        return [((bbox[1] + int(bbox[3] * CHIN_VPAD) - DELTA),(bbox[1] + int(bbox[3] * CHIN_VPAD) + DELTA)),
                ((bbox[0] + int(bbox[2] * CHIN_HPAD) - DELTA),(bbox[0] + int(bbox[2] * CHIN_HPAD) + DELTA))]



def midleft_cheek(frame, bbox, DELTA=DELTA, MLCHEEK_HPAD=MLCHEEK_HPAD, MLCHEEK_VPAD=MLCHEEK_VPAD, region = 'true'):
    if region.lower() == 'true':
        ...
        return [((bbox[1] + int(bbox[3] * MLCHEEK_VPAD) - DELTA),(bbox[1] + int(bbox[3] * MLCHEEK_VPAD) + DELTA)),
                ((bbox[0] + int(bbox[2] * MLCHEEK_HPAD) - DELTA),(bbox[0] + int(bbox[2] * MLCHEEK_HPAD) + DELTA))]
    


def midright_cheek(frame, bbox, DELTA=DELTA, MRCHEEK_HPAD=MRCHEEK_HPAD, MRCHEEK_VPAD=MRCHEEK_VPAD, region = 'true'):
    if region.lower() == 'true':
        ...
        return [((bbox[1] + int(bbox[3] * MRCHEEK_VPAD) - DELTA),(bbox[1] + int(bbox[3] * MRCHEEK_VPAD) + DELTA)),
                ((bbox[0] + int(bbox[2] * MRCHEEK_HPAD) - DELTA),(bbox[0] + int(bbox[2] * MRCHEEK_HPAD) + DELTA))]
