...
def run_POS_method_nomotionprocess(python_path, POS_method_script_without, data_npz_file):
...
if __name__ == '__main__':
    ...
    video_acquisition_script = '/Users/henryschnieders/Documents/Research/My_work_parts/Video_get_to_npy/YuNet_and_Template_match/VID_TO_DATA_whole_face.py'
    pixel_matching_script = '/Users/henryschnieders/Documents/Research/My_work_parts/motion_process/temporal_pixel_matching/forward_backward_pixel_matching_regions.py'
    motion_processing_script = '/Users/henryschnieders/Documents/Research/My_work_parts/motion_process/occulsion_processing/YuNet_and_Template_match/motion_process_fb.py'
    ...
    POS_method_script_without = '/Users/henryschnieders/Documents/Research/My_work_parts/POS_method/POS_method.py'


    data_npy_file = run_video_acquisition(python_path  = python_path,
                        video_acquisiton_script        = video_acquisition_script,
                        )
    ...
    pos_pdf_1 = run_POS_method_nomotionprocess(
                        python_path                  = python_path,
                        POS_method_script_without    = POS_method_script_without,
                        data_npz_file                = data_npz_file,
                    )


    merger = PdfMerger()
    for pdf in (motion_plots_path, chrom_pdf_1, chrom_pdf_2, pos_pdf_1):
        merger.append(pdf)
