...
if __name__ == '__main__':
    ...
    video_acquisition_script = '<USER_HOME>/Documents/Research/My_work_parts/Video_get_to_npy/YuNet_and_Template_match/VID_TO_DATA_whole_face.py'
    pixel_matching_script = '<USER_HOME>/Documents/Research/My_work_parts/motion_process/temporal_pixel_matching/forward_backward_pixel_matching_regions.py'
    motion_processing_script = '<USER_HOME>/Documents/Research/My_work_parts/motion_process/occulsion_processing/YuNet_and_Template_match/motion_process_fb.py'
    ...
    POS_method_script_without = '<USER_HOME>/Documents/Research/My_work_parts/POS_method/POS_method.py'
