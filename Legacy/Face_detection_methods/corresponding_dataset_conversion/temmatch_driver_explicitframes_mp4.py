...
def main(frames, roi, h, w):
    ...
    for frame in frames[1:]:
        ...
        area+=[np.array(cv2.cvtColor(frame[(top_left[1]-int(w*padding)):(bottom_right[1]+int(w*padding)), (top_left[0]-int(h*padding)):(bottom_right[0]+int(h*padding))],cv2.COLOR_BGR2GRAY))]
