...
image = Image.open('<USER_HOME>/Desktop/Research/My work/Data/facepic.png')
...
np.save('<USER_HOME>/Desktop/Research/My work/Data/intensity_map.npy', intensity_map)

# Optionally, you can display the image or perform further processing
image_resized.save('<USER_HOME>/Desktop/Research/My work/Data/facepic_resized.png')
