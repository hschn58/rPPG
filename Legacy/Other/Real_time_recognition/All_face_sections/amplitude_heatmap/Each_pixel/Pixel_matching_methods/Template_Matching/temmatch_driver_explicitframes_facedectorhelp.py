...
if __name__=="__main__":
    ...
    output_path_vid='<USER_HOME>/Desktop/Research/My_work/Real_time_recognition/All_face_sections/amplitude_heatmap/Each_pixel/Pixel_matching_methods/Template_Matching/Results/relax_facedetector.mp4'
