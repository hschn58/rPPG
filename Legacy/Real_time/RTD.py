...
face_area=[]
averaged = np.zeros((5, 3000)) #max frame range is 3000
while True:
    ...
    if frame_no%frame_interval==0:
        ...
        #get region of interest from last check 
        ...
        #update face area using template matching
